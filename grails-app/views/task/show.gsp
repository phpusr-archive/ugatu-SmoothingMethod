...
<div ng-app="app" ng-controller="TaskShowController" class="content">

    <h1>${title}</h1>

    <div class="container">
        <div ng-show="hasErrors" class="alert alert-danger" style="width: 600px; margin-top: 10px;">{{errorMessage}}</div>
